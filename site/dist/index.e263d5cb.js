...
})({"9Ril4":[function(require,module,exports) {
"use strict";
...
fetch(url).then((response)=>response.json()).then((response1)=>{
    const pokeBall = response1.results;
    const httpReq = pokeBall.map((pokemon)=>pokemon.url).map((url1)=>{
...
},{}]},["9Ril4","6gRYP"], "6gRYP", "parcelRequire80db")
